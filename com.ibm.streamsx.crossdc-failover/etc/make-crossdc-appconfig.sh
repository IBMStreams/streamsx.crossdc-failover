...
#streamtool chappconfig -d d1 -i i1 --property com.acme.test::MyTest1_dataSnapshotJdbcUrl=jdbc:db2://h0319b14.pok.hpc-ng.ibm.com:50000/boadb CrossDCFailover
#streamtool chappconfig -d d1 -i i1 --property com.acme.test::MyTest1_dataSnapshotJdbcUser=dragon CrossDCFailover
#streamtool chappconfig -d d1 -i i1 --property com.acme.test::MyTest1_dataSnapshotJdbcPassword=fire CrossDCFailover
...
#streamtool chappconfig -d d1 -i i1 --property com.acme.test::MyTest1_dataSnapshotJdbcDriverLib=opt/db2jcc4.jar CrossDCFailover
#streamtool chappconfig -d d1 -i i1 --property com.acme.test::MyTest1_dataSnapshotJdbcClassName=com.ibm.db2.jcc.DB2Driver CrossDCFailover
...
#streamtool chappconfig -d d1 -i i1 --property com.acme.test::MyTest1_dataSnapshotTableName=dc2_cdc_rep CrossDCFailover
#streamtool chappconfig -d d1 -i i1 --property com.acme.test::MyTest1_dataSnapshotPrimaryKeyColumnName=id CrossDCFailover
#
